    ...
    return (
      ...
      >
        <div className="text-center">
          <div
            className="w-20 h-20 rounded-full bg-amber-400/10 animate-pulse mx-auto"
      ...
      <div className="min-h-screen bg-bg flex flex-col items-center justify-center">
        ...
        <div className="relative w-full h-screen overflow-hidden">
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(135deg, #1a0800, #0f0820, #080810)',
            }}
          />
          ...
          {/* Overlay */}
          <div className="absolute inset-0 bg-linear-to-t from-bg via-bg/40 to-transparent z-10" />
        </div>

        {/* CONTENT */}
        <div
          className="absolute max-w-4xl mx-auto z-20 top-50"
          style={{
            marginTop: `-${s(24)}`,
            paddingLeft: s(6),
            paddingRight: s(6),
        ...
        >
          ...
          <Link
            href="/candidates"
            className="inline-flex items-center text-white/50 hover:text-amber-400 text-sm transition-colors"
            style={{
              gap: s(2),
              marginBottom: s(6),
            }}
            ...
            >
              ...
              <div className="relative w-28 h-28 sm:w-36 sm:h-36 rounded-2xl overflow-hidden flex-shrink-0 ring-4 ring-amber-400/30">
                ...
                {candidate.photo_url ? (
                  ...
                  <div className="w-full h-full bg-amber-900/40 flex items-center justify-center text-5xl">
                    🎤
                  </div>
                )}
              </div>
              ...
              <div className="flex-1">
                ...
                >
                  ...
                  {candidate.rank && (
                    <span
                      className="flex items-center text-sm text-amber-400 font-bold"
                      style={{ gap: s(1) }}
                    >
            ...
            {candidate.video_url && (
              <div style={{ marginTop: s(6) }}>
                ...
                <div className="rounded-2xl overflow-hidden aspect-video">
                  <iframe
                    src={candidate.video_url.replace(
                      'watch?v=',
                      'embed/'
                    )}
